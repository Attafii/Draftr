...
export function BrandMark({ size = 40, variant = "dark", className }: BrandMarkProps) {
  const surface = variant === "light" ? "#f5f5f5" : "#0b1220";
  const border = variant === "light" ? "rgba(9, 9, 11, 0.14)" : "rgba(255, 255, 255, 0.08)";
  const ink = variant === "light" ? "#09090b" : "#f8fafc";
  const muted = variant === "light" ? "rgba(9, 9, 11, 0.3)" : "rgba(255, 255, 255, 0.22)";
  ...
  return (
    ...
    >
      ...
      <path d="M37 14h10v10" stroke="url(#g1)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
